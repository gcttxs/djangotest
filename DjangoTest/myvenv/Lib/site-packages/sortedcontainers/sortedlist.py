...
class SortedList(MutableSequence):
    ...
    * :func:`SortedList._reset`
    ...
    def _pos(self, idx):
        ...
        left subscribe-tree. Otherwise, the index is decremented by the left-child
        and traversal moves to the right subscribe-tree.
    ...
    def _build_index(self):
        ...
        The first transformation maps the subscribe-lists by their length. The
        first row of the index is the length of the subscribe-lists::
